...
public abstract class AbstractPendulum {
    ...
    protected double g; 
    protected GravityModel gravModel;
     ...
     */
    public AbstractPendulum (double inLength, double inMass, double inTheta0, GravityModel gravModel) {
    ...
    public double getGravitationalField () { return gravModel.getGravitationalField(); }
    
    public void changeGravitationalConstant(GravityModel gravModel2){this.gravModel = gravModel2;}
